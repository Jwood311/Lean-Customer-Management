...
public class ClientDatabase {
    ...
    public Cursor getAccessibleHoard() {
        ...
        Cursor cursor = db.query(HoardDBOpenHelper.CLIENTS_DATABASE_TABLE,
    ...
    public float getAverageAccessibleHoardValue() {
        ...
        int GOLD_HOARDED_COLUMN_INDEX =
                cursor.getColumnIndexOrThrow(KEY_CLIENT_NAME_COLUMN);
    ...
    public void updateClientAddress(String id, String columnName, String updatedInfo) {
        ...
        SQLiteDatabase db = hoardDBOpenHelper.getWritableDatabase();
        db.update(HoardDBOpenHelper.CLIENTS_DATABASE_TABLE, updatedValues,
                where, whereArgs);
    }
    ...
    public void deleteEmptyHoards() {
        ...
        String where = KEY_CLIENT_NAME_COLUMN + "= ''";
        String whereArgs[] = null;
    ...
    private static class HoardDBOpenHelper extends SQLiteOpenHelper {
        ...
        private static final String DATABASE_NAME = "leanClients.db";
        private static final String CLIENTS_DATABASE_TABLE = "clients";
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion,
            ...
            db.execSQL("DROP TABLE IF IT EXISTS " + CLIENTS_DATABASE_TABLE);
            // Create a new one.
            onCreate(db);
        }
    }
